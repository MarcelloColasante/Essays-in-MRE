...
% normal base and views on linear combinations of first and second 
% non-central moments
...
threshold = 1e-7;
[theta_mu_view, theta_sig2_view, mu_pos, sig2_pos] = FitMRE12MomentsN(z_mu, z_sig, eta_mu_view, eta_sig2_view, mu_pri, sig2_pri, threshold);
